...
def enter():
    if not server.Floor_2[server.isaac_head.nowPos]:
        ...
        if rand_num == 0:
            ...
            game_world.add_objects(server.red_spiders, server.Mob_num)
    make_map.make_Map('d:/2DGP/Project/Stage/stage_2/stage_26.txt')
...
def update():
    ...
    if server.isaac_head.nowPos == 32:
        game_framework.change_state(Stage_2_map_32)
