...
def enter():
    ...
    #         game_world.add_objects(server.red_spiders, server.Mob_num)
    make_map.make_Map('d:/2DGP/Project/Stage/stage_2/stage_22.txt')
...
def update():
    ...
    if server.isaac_head.nowPos == 23:
        game_framework.change_state(Stage_2_map_23)
